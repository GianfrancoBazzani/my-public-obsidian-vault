...
- [AI / Research Articles / Knowdit-Agentic-Smart-Contract-Vulnerability-Detection-with-Auditing-Knowledge-Summarization](AI/Research%20Articles/Knowdit-Agentic-Smart-Contract-Vulnerability-Detection-with-Auditing-Knowledge-Summarization.pdf) — Paper on Knowdit, a knowledge-driven multi-agent framework that builds an auditing knowledge graph from human audit reports to detect DeFi smart contract vulnerabilities.
- [AI / Research Articles / MODEL-CONTEXT-CONTRACTS](AI/Research%20Articles/MODEL-CONTEXT-CONTRACTS.pdf) — Paper on Model Context Contracts, an MCP-enabled framework that lets LLM agents invoke blockchain smart contracts through natural language queries.

- [AI / Stanford CS230 / Lecture 8 Agents, Prompts, and RAG](AI/Stanford%20CS230/Lecture%208%20Agents,%20Prompts,%20and%20RAG.md) — Notes on Stanford CS230 lecture 8 by Kian Katanforoosh covering LLM limits, prompt engineering, fine-tuning, RAG, agentic workflows, evals, and multi-agent systems.

- [Blockchain / CCSS / CCSSA-exam-scenario-E-notes](Blockchain/CCSS/CCSSA-exam-scenario-E-notes.md) — Requirement-by-requirement CCSS v9.0 assessment of Exam Scenario E with In-Place, Not In-Place, or Not Applicable verdicts for each aspect control.
- [Blockchain / CCSS / CCSSA-exam-scenario-F-notes](Blockchain/CCSS/CCSSA-exam-scenario-F-notes.md) — Requirement-by-requirement CCSS v9.0 assessment of Exam Scenario F with In-Place, Not In-Place, or Not Applicable verdicts for each aspect control.
